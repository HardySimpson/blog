...
<!-- series: OpenCode 深度解析系列 -->
<div class="series-nav">
    <span class="series-label">系列：OpenCode 深度解析系列</span>
    <div class="series-links">
        <a href="/2026/03/16/agentloop-opencode/" class="nav prev">← OpenCode 学习：AgentLoop 核心代码模块拆解</a>
    </div>
</div>
