...
<div class="series-nav">
    ...
    <div class="series-links">
        <a href="/2026/03/20/acp-protocol-opencode-implementation/" class="nav prev">← ACP 协议解析：OpenCode 的 Agent 通信标准实现</a> &nbsp;|&nbsp; <a href="/2026/04/21/effect-framework-vs-harness/" class="nav next">Effect 框架 vs Harness：两种不同的 Agent 编程范式 →</a>
    </div>
</div>
...
3. [OpenCode AgentLoop 分析](https://hardysimpson.github.io/blog/2026/03/16/agentloop-opencode/)
