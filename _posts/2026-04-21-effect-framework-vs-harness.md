...
category: AI编程
excerpt: "Effect 框架 vs Harness：两种不同的 Agent 编程范式深度对比"
...
<div class="series-nav">
    ...
    <div class="series-links">
        <a href="/2026/04/13/opencode-context-compaction-algorithm/" class="nav prev">← OpenCode 上下文压缩算法深度解析</a> &nbsp;|&nbsp; <a href="/2026/04/21/cli-pipe-model-implementation/" class="nav next">CLI 管道模型在 AI Agent 中的落地：Skills 与 Tools 的对接机制 →</a>
    </div>
</div>
