...
1. 为什么需要Agent，进行 人-代码库-LLM之间的对话？


2. 一个代码仓库，有几十万行代码，上下文很长，Agent在和LLM对话的时候，怎么取舍？


3. 编写的代码，怎么保证是大致可运行的？为什么能保证不乱写？


4. Agent到底是薄薄的一层胶水，还是非常厚重的workflow参考书？
...
<div class="series-nav">
    ...
    <div class="series-links">
        <a href="/2026/03/16/agentloop-opencode/" class="nav next">OpenCode 学习：AgentLoop 核心代码模块拆解 →</a>
    </div>
</div>
...
*本文档部分基于 OpenCode 项目的 prompt.ts 文件分析编写*